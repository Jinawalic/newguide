...
const EmptyStatePreview = () => {
    return (
        <div className="w-full max-w-sm mx-auto flex flex-col items-center p-12 bg-white rounded-xl shadow-sm shadow-slate-900/10 border border-slate-100 text-center relative z-[100] animate-in zoom-in-95 duration-500">
            <div className="relative mb-8 group">
                ...
                <div className="w-24 h-24 bg-white rounded-[32px] flex items-center justify-center text-slate-300 border border-slate-100 shadow-xl shadow-slate-200/50 relative z-10 transition-transform duration-500 group-hover:-rotate-3 group-hover:scale-105">
                    <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9Z" /></svg>
                </div>
            </div>

            <h3 className="text-2xl font-black text-slate-900 tracking-tight mb-3">No documents yet</h3>
            <p className="text-[13px] text-slate-400 font-bold leading-relaxed mb-10 max-w-[220px]">Upload your first project files to start organizing your digital workspace.</p>

            <button className="px-8 h-12 bg-emerald-800 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-emerald-900/20 active:scale-[0.98] transition-all flex items-center gap-3">
            ...
            <div className="mt-6 flex items-center gap-1.5 grayscale opacity-50">
                ...
                <div className="w-6 h-1 rounded-full bg-slate-100" />
                <div className="w-6 h-1 rounded-full bg-slate-50" />
            </div>
        </div>
    );
};
