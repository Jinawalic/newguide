...
const ResizablePreview = () => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center p-8 bg-slate-50 rounded-xl border border-slate-200 relative z-[100]">
            <div
                ref={containerRef}
                className="w-full max-w-2xl h-80 bg-white border border-slate-200 rounded-xl overflow-hidden flex shadow-2xl shadow-slate-900/10"
            >
                <div style={{ width: leftWidth }} className="flex-shrink-0 bg-slate-50 p-6 flex flex-col border-r border-slate-100">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="h-4 w-5/6 bg-slate-200 rounded-lg animate-pulse" />
                    </div>
                </div>

                <div
                    onMouseDown={onMouseDown}
                    className="w-1 bg-slate-100 hover:bg-emerald-500 cursor-col-resize transition-colors relative z-10 group"
                >
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:bg-emerald-50 transition-all opacity-0 group-hover:opacity-100 delay-75">
                ...
                <div className="flex-1 p-8 space-y-6">
                    ...
                    <div className="h-32 w-full bg-slate-50 rounded-[28px] border border-dashed border-slate-200 animate-pulse" />
            ...
            <div className="absolute bottom-10 mb-3 left-10 flex flex-col items-start gap-1">
                <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Panel Width</span>
                <span className="text-xl font-bold text-emerald-500 tracking-tighter">{Math.round(leftWidth)}px</span>
            </div>
        </div>
    );
};
...
export const ResizablePanels = () => {
    ...
    return (
        <div className="max-w-[1000px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="border border-slate-200 rounded-xl bg-white overflow-hidden shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)]">
