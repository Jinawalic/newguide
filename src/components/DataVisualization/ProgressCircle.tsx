        ...
        <div className="w-full max-w-sm mx-auto flex flex-col items-center gap-12 relative z-[100]">
            <div className="relative group">
                <svg width="200" height="200" className="transform -rotate-90">
                    <circle cx="100" cy="100" r="85" stroke="currentColor" strokeWidth="16" fill="transparent" className="text-slate-50" />
                    <circle cx="100" cy="100" r="85" stroke="currentColor" strokeWidth="16" strokeDasharray="534" strokeDashoffset="133" strokeLinecap="round" fill="transparent" className="text-emerald-500 transition-all duration-1000 group-hover:stroke-emerald-600" />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-5xl font-black text-slate-900 tracking-tighter">75%</span>
                    <span className="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Completion</span>
                </div>
            </div>
                    ...
                    <div key={i} className="flex flex-col items-center gap-3">
                        <div className="relative">
                            <svg width="64" height="64" className="transform -rotate-90">
                                ...
                                <circle cx="32" cy="32" r="28" stroke="currentColor" strokeWidth="6" strokeDasharray="175.9" strokeDashoffset={175.9 - (p.val / 100) * 175.9} strokeLinecap="round" fill="transparent" className={`text-${p.col}-500`} />
                            </svg>
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="text-[10px] font-black">{p.val}%</span>
                            </div>
                        </div>
                    </div>
                ))}
        ...
        <div className="max-w-[1000px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="mb-10">
                <div className="flex items-center gap-3 mb-4">
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight font-heading">Progress Circle</h2>
            ...
            <div className="mt-8 flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div>
                    <h4 className="text-sm font-bold text-slate-900 mb-1">Implementation Detail</h4>
